...
object GeofenceStorage {
    ...
    val cursor: Cursor
        get() {
            val columns = arrayOf(GeofenceContract.GeofenceEntry._ID, GeofenceContract.GeofenceEntry.COLUMN_NAME_NUMBERS, GeofenceContract.GeofenceEntry.COLUMN_NAME_LNG, GeofenceContract.GeofenceEntry.COLUMN_NAME_LAT, GeofenceContract.GeofenceEntry.COLUMN_NAME_EXPIRES)
    ...
    fun removeGeofence(requestId: String) {
        val where = GeofenceContract.GeofenceEntry.COLUMN_NAME_NUMBERS + " = '" + requestId + "'"
